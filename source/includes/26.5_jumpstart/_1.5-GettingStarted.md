...
Execute the JumpStart.exe file from a command line. Execution requires specifying the JumpStartEnvironment.json as the second parameter: For example, using the AcmeTv.json file:


`JumpStart.exe SampleDriverFiles/AcmeTV.json .\JumpStartEnvironment.json`
